...
R es uno de los opciones para analizar y analizar datos. Para usarla facilmente, puede usar R Studio. Se pone más facíl su uso de R.
...
Cada fila es una fecha en que ha observado/colectado los datos. Los columnos son abundancia de individuous por familias/especies.
