...
Para una figura de un paper científico, es normal añadir números o letras a cada grafico para que puede explicar cada uno en su leyenda. Puede hacer ese de forma automática en patchwork así:
por números: Plot_annotation(tag_levels = c(“1”)) 
por letras: Plot_annotation(tag_levels = c(“a”)) 
...
* https://es.r4ds.hadley.nz/  este libro (español) super bueno y descriptivo
* Stackoverflow <- donde gente pide ayuda por sus preguntas en R y otras se responden, puede ser ayudante (mayormente ingles)
*	Pagina de UCLA <- en ingles pero con buen ejemplos https://stats.oarc.ucla.edu/other/dae/
*	Yo! Y sus profes
