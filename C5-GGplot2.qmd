...
El función 'facet_wrap' y 'facet_grid', mover los datos para que muestran más.
...
Podemos también usar más que dos variables con 'facet_grid'.
...
Es más fácil ver ahora los especies y en cual isla estan.
...
-   Elegir los colúmnos con variables que quiere poner juntos en una gráfica. Ahora es largo pico y alto pico del pinguinos, entonces los pone en cols=.

-   Después, elegimos un nombre para un colúmno para poner las nombres de los colúmnos (acá caracteristica) y una para un colúmno nuevo para los valores (acá Medidasmm)

-   El nuevo dataframe: 'pinguinos_longer' tiene dos nuevos colúmnos 'caracteristica' y 'medidasmm'
...
Estos dos tecnicas son más dificíl pero imensamente útil.
